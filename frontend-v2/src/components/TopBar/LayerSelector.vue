...
<template>
  <div>
    <div
      ...
      class="layer-btn"
      :class="{ selectedlayer: selectedLayer === layerId }"
      @click="changeLayer(layerId)"
    >
      {{ layerId }}
    </div>
  </div>
...
<style lang="postcss" scoped>
  .layer-btn {
    @apply inline-block p-2 mx-2 rounded font-semibold text-gray-800 bg-gray-200 hover:bg-gray-500 transition-all cursor-pointer w-10 text-center;
  }
  .selectedlayer {
